...
# [98]	valid_0's multi_logloss: 0.689866
# Fold 1 F1: 0.4156
# Training until validation scores don't improve for 100 rounds
# Early stopping, best iteration is:
# [24]	valid_0's multi_logloss: 1.40664
# Fold 2 F1: 0.3077
# Training until validation scores don't improve for 100 rounds
# Early stopping, best iteration is:
# [121]	valid_0's multi_logloss: 0.530967
# Fold 3 F1: 0.5311
# Training until validation scores don't improve for 100 rounds
# Early stopping, best iteration is:
# [293]	valid_0's multi_logloss: 0.370766
# Fold 4 F1: 0.5114
# LGB 平均CV分数: 0.4415
...
# 训练 transformer 模型...
# Epoch 0: Train F1: 0.6234, Val F1: 0.4060
# Epoch 5: Train F1: 0.7137, Val F1: 0.3332
# Epoch 10: Train F1: 0.7469, Val F1: 0.3256
# Early stopping at epoch 12
# transformer 最佳验证F1: 0.4429

# 训练 cnn 模型...
# Epoch 0: Train F1: 0.5198, Val F1: 0.3909
# Epoch 5: Train F1: 0.7067, Val F1: 0.4407
# Epoch 10: Train F1: 0.7458, Val F1: 0.4856
# Epoch 15: Train F1: 0.7684, Val F1: 0.4604
# Early stopping at epoch 18
# cnn 最佳验证F1: 0.4856

# 进行高级集成预测...
# 模型权重: [0.19203407 0.2051003  0.19893843 0.19267712 0.21125008]
...
# 后续的优化方向就是：
# 添加更多有效的特征工程，模型的深度可以加深一些，融合多个有差异且效果好的模型